...
export function EarningsChart() {
  ...
  const setRange = useCallback(
    (next: EarningsTimeRange) => {
      ...
      // Track range change
      analytics.trackEvent('earnings_chart_range_changed', {
        from_range: range,
        to_range: next
      });
    },
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      // Track chart data load
      analytics.trackEvent('earnings_chart_loaded', {
        range,
        data_points: result.data.length,
      ...
      // Track chart error
      analytics.trackEvent('earnings_chart_error', {
        range,
