...
export default function SubscribePage() {
  return (
    <div className="p-8">
      ...
      {/* Old subscription flow - always visible */}
      <div className="mb-8">
      ...
      {/* New subscription flow - behind feature flag */}
      <FeatureFlag feature="newSubscriptionFlow">
        <div className="mb-8 border-2 border-green-500 p-4 rounded">
          <h2 className="text-xl mb-2">New Enhanced Subscription Flow</h2>
      ...
      {/* Crypto payments - behind feature flag */}
      <FeatureFlag
        feature="cryptoPayments"
        fallback={
          <p className="text-gray-500">Crypto payments coming soon!</p>
        }
      >
