...
import TransactionProgress from "../tx-progress/TransactionProgress"; // ✅ Added
...
export default function CheckoutFlow({
  ...
  const handleSubmit = useCallback(async () => {
    ...
    setTxStage("signing"); // ✅ start signing stage

    await tx.execute(async () => {
      setTxStage("pending"); // ✅ transaction pending
      ...
      const txHash = await new Promise<string>((resolve, reject) => {
        setTimeout(() => {
          ...
          if (shouldFail) {
            ...
            const hash = `tx_${Date.now()}_${Math.random()
              .toString(36)
              .substr(2, 9)}`;
            resolve(hash);
          }
      ...
      setTxStage("confirmed"); // ✅ confirmed stage
      ...
      {currentStep === "confirm" &&
        ...
        transactionPreview && (
          <div className="space-y-4">
            ...
            <TransactionProgress stage={txStage} txHash={txHash} />
