...
export default function Hamburger({ isOpen, onClick }: { isOpen: boolean; onClick: () => void }) {
  return (
    <button onClick={onClick} style={{ position: 'fixed', top: '1rem', left: '1rem', zIndex: 50, padding: '0.5rem', minHeight: '44px', minWidth: '44px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', borderRadius: '0.5rem', border: '1px solid #e5e7eb' }} className="lg:hidden" aria-label="Toggle menu" aria-expanded={isOpen}>
